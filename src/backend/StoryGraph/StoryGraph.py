class StoryGraph:
    def __init__(self):
        self._earlyEvidence = [
            ...
            ("Witness Testimonies – Several written statements from bar patrons who saw the suspect and the CEO drinking together, with some recalling an argument.", "early2.png"),
            #("Bar Receipt – A receipt from the bar, proving that the suspect and the CEO were drinking heavily on the night of the murder.", "early3.png")
        ]
        self._midEvidence = [
            ("Blood-Stained Clothing – The police found the suspect's shirt and jacket with blood stains. They ask if he remembers how it got there.", "mid1.png"),
            ("Photo of the Alleyway – A police photograph of the alleyway where the suspect was seen walking home, looking disoriented and covered in blood.", "mid2.png"),
            #("Neighbors’ Statements – People living near the suspect's apartment reported seeing them return home in a confused and unstable state.", "mid3.png")
        ]
        self._finalEvidence = [
            ("Gun Matching the Bullet Wound – The murder weapon is found near the crime scene, and detectives claim it matches the suspect's fingerprints.", "final1.png"),
            ("Johnny’s Last Notes – A notebook belonging to Johnny, containing scribbled messages about Vinh Davis’s crimes. It also mentions the suspect's name, suggesting Johnny trusted the employee to help him.", "final2.png"),
            #("The Suspect's Own Camera Film – The detectives show a developed film roll from the suspect's camera found at the crime scene, possibly containing a blurred or distorted photo from the altercation.", "final3.png"),
